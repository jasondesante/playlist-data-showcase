...
- [x] Test subdivision pipeline
  - [x] BeatMap → InterpolatedBeatMap → UnifiedBeatMap → SubdividedBeatMap
  - [x] Real-time subdivision switching
  - [x] BeatStream with SubdividedBeatMap
