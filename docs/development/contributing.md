...
- **CSS** - Styling (pure CSS, no Tailwind)
- **Lucide React** - Icons
...
2. Follow the tab component pattern (see [Architecture Overview](../architecture/overview.md))
...
docs: update architecture documentation with new hook pattern
```
...
- **[Data Engine Reference](../engine/data-engine-reference.md)** - Complete engine API docs
