study docs/plans/BEAT_DETECTION_STEP_UI_PLAN.md and pick the most important thing to do. 
...
- update docs/plans/BEAT_DETECTION_STEP_UI_PLAN.md when the task is completed
