study UI_IMPROVEMENT_PLAN.md and pick the most important thing to do. 
...
I might add new stuff to the UI_IMPROVEMENT_PLAN.md file. If you see that, add new tasks based on those requests, add them to the list and cross out what I wrote to signify you added them as tasks.
...
IM PRAY TO FUCKING GOD PLEASE DONT DO A SINGLE THING TO THE CODE AT ALL BEFORE FIXING THE FUCKING EXTRA BRACKET MISSING BRACKET BULLSHIT CSS ERROR I KEEP SEEING HOLY FUCK PLEASE STOP WORKING ON OTHER THINGS THE CODE DOESNT EVEN WORK THERES CRITICAL ERRORS AND YOU IGNORE THEM AND KEEP WORKING NIGGER THE SITE IS FUCKING BROKENNNNNNN FIX IT


ALSO WHY IS THE index.css file over 10k lines of css the css doesn't even look good its like trash level css with countless bullshit retard level errors like an extra bracket here and there which YOU CANT EVEN CATCH ON YOUR OWN DESPITE COUNTLESS WAYS FOR THE CODE TO TELL YOU IT CANT COMPILE AND YOU CANT EVEN GIVE ME A NICE WRITE UP ABOUT WHY THIS SHIT ISNT WORKING AND WHY YOU CANT SEE THE BUILD ERRORS OR WHATEVER.

CAN YOU SEE THE BUILD ERRORS?!?!? OR ARE YOU JUST STUPID?!?
...
- When you are completely finished with all the tasks you can do, finalize the loop by saying "ITS TIME TO EAT"
