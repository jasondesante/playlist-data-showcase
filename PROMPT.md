study docs/plans/AUTO_LEVEL_GENERATION_UI_PLAN.md and pick the most important thing to do. 
...
- update docs/plans/AUTO_LEVEL_GENERATION_UI_PLAN.md when the task is completed
