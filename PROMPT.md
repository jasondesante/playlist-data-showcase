study docs/plans/PATTERN_PLACEMENT_REWRITE_PLAN.md and pick the most important thing to do. 
...
- update docs/plans/PATTERN_PLACEMENT_REWRITE_PLAN.md when the task is completed
