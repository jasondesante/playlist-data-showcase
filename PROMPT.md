study docs/plans/TYPE_AND_CLEANUP_INVESTIGATION_PLAN.md and pick the most important thing to do. 
...
- update docs/plans/TYPE_AND_CLEANUP_INVESTIGATION_PLAN.md when the task is completed
