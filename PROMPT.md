study docs/plans/BAND_BIAS_WEIGHTS_PLAN.md and pick the most important thing to do. 
...
- update docs/plans/BAND_BIAS_WEIGHTS_PLAN.md when the task is completed
