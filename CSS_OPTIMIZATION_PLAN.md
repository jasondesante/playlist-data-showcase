...
**Task 21: Combat Tab**
- [x] Create `CombatSimulatorTab.css`
- [x] Copy all combat styles from index.css
- [x] Consolidate duplicates, replace hardcoded values
- [x] Add import to component
...
- [x] [Task 23e] Verify XPCalculatorTab classes are moved from index.css
...
- [x] [Task 23j] Verify SettingsTab classes are moved from index.css
